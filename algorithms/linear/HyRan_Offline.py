...
class HyRan_Offline(Algorithm):
    def __init__(self, d, k, L, p, info=None):
        super().__init__(f'HyRan_{info}' if info is not None else 'HyRan', d=d, k=k, L=L)
        ##Initialization
        self.t = 1
        ...
        for _ in range(self.L):
            ...
            self.beta_tilde_arr.append(np.zeros((self.k,)))
